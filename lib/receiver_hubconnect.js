...
var ignoreTheseAttributes = require('./he_hubconnect_api.js').ignoreTheseAttributes;
var clients = [];
...
var receiver_hubconnect = {
    start: function(platform) {
        ...
        platform.api.connect("http://" + platform.local_ip + ":" + platform.local_port + "/",
                            "local", "1234567890", "Homebridge " + platform.config['name'], function (data) {
            platform.log('connect resp: ' + data);
        });
        ...
        if (platform.hsm)
        {
            ...
            var url = 'ws://' + platform.api.getAppHost().match(r) + '/eventsocket';
